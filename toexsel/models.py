...
class Graduate2012(models.Model):
    ...
    birthyear1 = models.CharField('Туылган жылы1',max_length=15,blank=True,null=True)
    birthyear2 = models.CharField('Туылган жылы2',max_length=15,blank=True,null=True)
    jekekualik = models.CharField('жеке куәлік №',max_length=30,blank=True,null=True)
    jsn = models.CharField('ЖСН (ИИН)',max_length=30,blank=True,null=True)
    ctn = models.CharField('СТН (РНН)',max_length=30,blank=True,null=True)
    nation = models.CharField('улты',max_length=10,blank=True,null=True)
    azamattik = models.CharField('азаматтығы',max_length=10,blank=True,null=True)
    address = models.CharField('Мекен-жайы',max_length=255,blank=True,null=True)
    workplace = models.CharField('Жұмыс орны',max_length=255,blank=True,null=True)
...
class Graduate2013(models.Model):
    ...
    fio = models.CharField('Тегі-аты әкесінің аты',max_length=255,blank=True,null=True)
    birthday = models.CharField('туган күні',max_length=20,blank=True,null=True)
    pol = models.CharField('Пол',max_length=12,blank=True,null=True)
    nation = models.CharField('улты',max_length=10,blank=True,null=True)
    dateto = models.CharField('Дата выдачи',max_length=30,blank=True,null=True)
    numberpasport = models.CharField('жеке куәлік №',max_length=15,blank=True,null=True)
    whotake = models.CharField('Кем выдан',max_length=15,blank=True,null=True)
    datefor = models.CharField('Дата выдачи',max_length=30,blank=True,null=True)
